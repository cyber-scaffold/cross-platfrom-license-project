...
import { generateInjectableDehydrateContent, generateDehydrateHTMLContent, generateHydrateScriptTagPath, generateHydrateStyleTagPath } from "@/main/server/utils/renderInfomations";
...
export class ServerSiderRenderService {
  ...
  public async render(params: ServerSiderRenderParamsType): Promise<string> {
    ...
    const _DEHYDRATE_HTML_CONTENT_ = await generateDehydrateHTMLContent(params);
